...
export type AgentTask = { id: string; workspace_id: string; goal: string; mode: "auto" | "document" | "coding"; test_command: "pytest" | "unittest" | "compile"; task_type: string; required_capabilities: string[]; input_file_ids: string[]; knowledge_base_ids: string[]; requested_outputs: string[]; status: TaskStatus; created_at: string; updated_at: string; latest_run: TaskRun | null };
